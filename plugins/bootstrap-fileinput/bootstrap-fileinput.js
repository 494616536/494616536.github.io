    ...
    FileInput.prototype = {
        ...
        _initZoom: function () {
            ...
            if (!self.$modal || !self.$modal.length) {
                $dialog = $(document.createElement('div')).html(modalMain).appendTo("#modelContainerDiv");
        ...
        disable: function () {
            ...
            self.$container.find(".btn-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button:not(.kv-file-zoom)").attr(
                "disabled",
                true);
            self._initDragDrop();
            return self.$element;
