+function ($) {
	...
	Confirmation.prototype.setContent = function () {
		...
		var popover    = $tip.find('.popover-content');
	...
	Confirmation.prototype.getBtnCancelHide = function () {
		var $e = this.$element;
		var o  = this.options;
		
		return $e.attr('data-btnCancelHide') || (typeof o.btnCancelHide == 'function' ? o.btnCancelHide.call($e[0]) : o.btnCancelHide);
	}
